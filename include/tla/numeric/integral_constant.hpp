...
struct C {
    ...
    ASCENDCT_HOST_DEVICE constexpr operator   value_type() const noexcept { return value; }
    ASCENDCT_HOST_DEVICE constexpr value_type operator()() const noexcept { return value; }
};
