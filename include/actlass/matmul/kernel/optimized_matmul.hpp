...
#ifndef ACTLASS_MATMUL_KERNEL_PADDING_MATMUL_HPP
#define ACTLASS_MATMUL_KERNEL_PADDING_MATMUL_HPP
...
#include "actlass/arch/cross_core_sync.hpp"
#include "actlass/epilogue/tile/copy_gm_to_ub.hpp"
#include "actlass/epilogue/tile/copy_ub_to_gm.hpp"
...
public:
    ...
    using CopyGm2Ub = actlass::epilogue::tile::CopyGm2Ub<
        ArchTag, matmul::MatmulType<Element, actlass::layout::RowMajor>>;
    using CopyUb2Gm = actlass::epilogue::tile::CopyUb2Gm<
        ArchTag, matmul::MatmulType<Element, actlass::layout::RowMajor>>;
    using ComputeLayout = actlass::layout::RowMajor;
...
public:
    ...
    void operator()<AscendC::AIV>(Params const &params)
    {
        ...
        if (!IsSameStride(params.layoutWA, params.layoutA) || !IsSameStride(params.layoutWB, params.layoutB)) {
            actlass::arch::CrossCoreBarrier<0x0, PIPE_MTE3>();
            actlass::arch::CrossCoreSetFlag<0x2, PIPE_MTE3>(flagAivFinishPadding);
        }
    }
    ...
    {
        if (!IsSameStride(params.layoutWA, params.layoutA) || !IsSameStride(params.layoutWB, params.layoutB)) {
            actlass::arch::CrossCoreWaitFlag(flagAivFinishPadding);
        }
...
#endif // ACTLASS_MATMUL_KERNEL_PADDING_MATMUL_HPP