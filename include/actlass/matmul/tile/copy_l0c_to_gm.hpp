...
#ifndef ACTLASS_MATMUL_TILE_COPY_L0C_TO_GM_HPP
#define ACTLASS_MATMUL_TILE_COPY_L0C_TO_GM_HPP
...
template <
    ...
    bool ReluEnable_
>
struct CopyL0CToGm<actlass::arch::AtlasA2,
                   ElementAccumulator_,
                   matmul::MatmulType<ElementDst_, layout::RowMajor>,
                   ScaleGranularity::NO_QUANT,
                   ReluEnable_>
{
    using ArchTag = actlass::arch::AtlasA2;
    using ElementDst = ElementDst_;
    using ElementSrc = ElementAccumulator_;
    using LayoutSrc = actlass::layout::zN;
    using LayoutDst = actlass::layout::RowMajor;
                   ...
                   ReluEnable_>
{
    ...
    using ElementSrc = ElementAccumulator_;
    using LayoutSrc = actlass::layout::zN;
    using LayoutDst = actlass::layout::zN;
    static constexpr auto quantPre = CopyL0CToGmQuantMode<ArchTag, ElementSrc, ElementDst,
        ScaleGranularity::NO_QUANT>::VALUE;
    static constexpr auto reluEn = ReluEnable_;
...
#endif // ACTLASS_MATMUL_TILE_COPY_L0C_TO_GM_HPP
